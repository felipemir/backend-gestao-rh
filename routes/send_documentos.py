...
@bp_send_documentos.route(
    "/api/documentos/download/<int:documento_id>", methods=["GET"]
)
def download_documento(documento_id):
    ...
    try:
        ...
        if not os.path.exists(caminho_arquivo):
            ...
            print(
                f"ERRO: Arquivo não encontrado no disco, mas existe no DB. ID: {documento_id}, Caminho: {caminho_arquivo}"
            )
