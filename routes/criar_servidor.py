...
def criar_servidor():
    ...
    try:
        ...
        if not validate:
            return (
                jsonify({"erro": "Dados inválidos", "mensagem": validator.errors}),
                400,
            )
        ...
        try:
            ...
            return (
                jsonify(
                    {"erro": "Erro ao consultar duplicidade", "mensagem": str(db_err)}
                ),
                500,
            )
        ...
        try:
            ...
            print(db_err)
            return (
                jsonify({"erro": "Erro ao inserir servidor", "mensagem": str(db_err)}),
                500,
            )
