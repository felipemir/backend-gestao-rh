...
from conection import (
    conect,
)  # Certifique-se de que o módulo 'conection' está no mesmo diretório ou no PYTHONPATH
...
def recuperar_template(template_id, caminho_destino):
    ...
    try:
        ...
        cursor.execute(
            "SELECT nome, conteudo FROM templates WHERE id = %s", (template_id,)
        )
        ...
        print(
            f"Arquivo '{template['nome']}' recuperado com sucesso e salvo em '{caminho_arquivo}'!"
        )
